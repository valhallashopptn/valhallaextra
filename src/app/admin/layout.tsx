...
import { LayoutDashboard, ShoppingCart, Package, PanelLeft, Tag, Palette, CreditCard, KeySquare } from 'lucide-react';
          ...
          <Sidebar>
              ...
              <SidebarMenu className="mt-4">
                  ...
                  <SidebarMenuButton asChild isActive={pathname.startsWith('/admin/products')}>
                   ...
                   <SidebarMenuItem className="admin-sidebar-menu-item">
                  <SidebarMenuButton asChild isActive={pathname.startsWith('/admin/digital-assets')}>
